        ...
        <View style={styles.centered_view}>
          {itemchon && (
            <>
              ...
              <Text style ={styles.texttenHoa}>{itemchon.TenHoa}</Text>
              <Text style ={styles.textgiahoa}>Giá bán {itemchon.GiaBan}</Text>
              <Text style = {styles.textthanhphan}>{itemchon.ThanhPhan}</Text>
              <Pressable onPress={() => setModalVisible(false)}>
                <Text style={styles.textdong}>Đóng</Text>
              </Pressable>
            </>
          )}
        </View>
